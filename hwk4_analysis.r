...
# # Perform propensity score matching for data below the 3-star threshold
# match.dat_below3 <- matchit(treat ~ plan_type + partd, 
#                             data = ma.rd3 %>% 
#                               filter(score < 3, 
#                                      !is.na(treat), 
#                                      plan_type == "HMO", 
...
# # Perform propensity score matching for data above the 3-star threshold
# match.dat_above3 <- matchit(treat ~ plan_type + partd, 
#                             data = ma.rd3 %>% 
#                               filter(score >= 3, 
#                                      !is.na(treat), 
#                                      plan_type == "HMO", 
...
#                             method = NULL, distance = "mahalanobis")
# # Create Love plots
# love.plot(match.dat_below3, abs = TRUE)
# love.plot(match.dat_above3, abs = TRUE)
